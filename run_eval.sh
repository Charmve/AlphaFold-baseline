...
# alphafold welcome chart

echo "
  ___  _       _            _____    _     _ 
 / _ \| |     | | baseline |  ___|  | |   | |
/ /_\ \ |_ __ | |__    __ _| |_ ___ | | __| |
|  _  | | '_ \| '_ \  / _` |  _/ _ \| |/ _` |
| | | | | |_) | | | || (_| | || (_) | | (_| |
\_| |_/_| .__/|_| |_| \__,_\_| \___/|_|\__,_|
        | |                                 
        |_|                   by Charmve                                   
...
TARGET_PATH="casp13_data/${TARGET}"  # Path to the directory with the target input data.
